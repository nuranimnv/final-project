            ...
            <div className="pt-64 max-lg:pt-10 ">
                <div className="flex justify-between max-lg:flex-col lg:items-center relative  max-lg:overflow-hidden lg:mb-20">
                    <div className='bg-[#E22733] lg:rounded-tr-[220px] lg:w-[40%] mt-20 leading-none h-[620px] max-xl:h-[500px] max-[1200px]:h-[460px] '>
                        <h1 className='text-[60px] max-[1200px]:text-[50px] max-lg:text-[45px] py-[180px] max-xl:py-[160px] max-lg:py-[40px] max-w-[600px] mx-auto mt-10 mb-0 text-white px-[30px] '><span className='font-turbinado text-[90px] max-[1200px]:text-[60px] text-[#FED455]'>INCorn</span><p className='px-20 max-xl:px-10 max-lg:px-0'> Roadshows & Tastings <span className=' text-[#FED455]'>.</span></p> </h1>
                    </div>
