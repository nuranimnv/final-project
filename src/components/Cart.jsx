              ...
              {combined?.map((item, index) => (
                <tr key={index} className="text-[#613223] ">
                  ...
                  <td className="text-[20px] text-right  max-md:text-[17px]  ">
                    ...
                    <button
                      onClick={() =>
                        deleteItem(item.names, item.price, item.diff)
                      }
                      className="font-normal underline text-[12px] text-[#613223]"
                    >
                      Delete
                    </button>
                  </td>
          ...
          {combined.length > 0 ? (
            <div className="relative ">
              ...
              <div className="flex justify-between mt-4 max-lg:text-[13px]">
                <NavLink
                  to={"/cart/"}
                  className="font-bold bg-[#EDF0F7] hover:bg-white border border-[#D8E0F0] duration-300 p-1 px-8 rounded-full"
                >
                  <button>Edit Cart</button>
                </NavLink>
                <NavLink
                  className="flex w-[67%] text-white rounded-full justify-center py-[7px] bg-[#e22733] duration-300 hover:bg-[#a7002f] items-center"
                  to={"/checkout/"}
                >
